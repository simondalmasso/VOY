...
EVIDENCE_DOCS_LINEAGE_START=61e318dfe6a51679b571f257f3ee3401b8b821a7
MERGE_AUTHORIZED=NO
...
Production truth has priority over branch/document state. Candidate runtime source and later evidence/docs-only commits are intentionally recorded separately. Branch heads from `EVIDENCE_DOCS_LINEAGE_START` onward are documentation/control state, not candidate runtime sources and must never be substituted for `V6_EXACT_RUNTIME_SOURCE_SHA`.
