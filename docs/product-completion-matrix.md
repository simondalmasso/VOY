...
| Validation | real runtime destination success, forged/unverified negatives, frozen install, exact-head CI, typecheck, lint, tests, build, budgets, dry-run, clean browser matrix and candidate evidence |
