...
const requestLog=[];
const faults={moduleOnce:0,manifest:null,chunk:null};
...
function resetFaults(){faults.moduleOnce=0;faults.manifest=null;faults.chunk=null}
...
try{
  {
    ...
    try{
      ...
      assert.equal((await page.locator('h1').textContent()).trim(),'Sin conexión');
